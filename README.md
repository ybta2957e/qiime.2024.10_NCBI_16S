...
```
```
qiime rescript filter-seqs-length-by-taxon --i-sequences ncbi-refseqs-unfiltered.qza \
...
```
qiime rescript filter-taxa --i-taxonomy ncbi-refseqs-taxonomy-unfiltered.qza \
